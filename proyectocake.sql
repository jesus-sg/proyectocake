...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-06-2020 a las 00:42:47
...
CREATE TABLE `clientes` (
  ...
  `cl_nitempresa` varchar(100) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `cl_nombre` varchar(80) NOT NULL,
  `cl_direccion` varchar(80) NOT NULL,
  `cl_email` varchar(80) NOT NULL,
  `cL_barrio` varchar(80) DEFAULT NULL,
  `cl_documento` varchar(80) DEFAULT NULL,
  `cl_fechacrea` datetime DEFAULT NULL,
  `cl_fechamod` datetime DEFAULT NULL,
  `cl_usuariocrea` int(11) DEFAULT NULL,
  `cl_usuariomod` int(11) DEFAULT NULL,
  `cl_estado` int(11) DEFAULT NULL,
  `cl_telefono` varchar(80) DEFAULT NULL
...
INSERT INTO `clientes` (`cl_id`, `cl_nitempresa`, `cl_nombre`, `cl_direccion`, `cl_email`, `cL_barrio`, `cl_documento`, `cl_fechacrea`, `cl_fechamod`, `cl_usuariocrea`, `cl_usuariomod`, `cl_estado`, `cl_telefono`) VALUES
(1, '654321', '223', '2332', '23', NULL, '233222', NULL, NULL, NULL, NULL, 1, '23');
...
(5, '654321', 'juan26', 'juan carlos', '700a6c7459e78d0b0ecbaaead4f91318', 3, '30051025', '', 1, 1, '', '2020-06-19 04:45:01', '2020-06-21 01:27:15', 1, 1, 2);
